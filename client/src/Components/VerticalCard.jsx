...
function VerticalCard({ loading, data = [] }) {
  ...
  return (
    <div>
      <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,320px))] justify-center md:justify-between gap-2 md:gap-4 overflow-scroll scrollbar-none transition-all">
        {loading
